...
async def cmd_help(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    text = (
        ...
        "  • table — табличный отчёт (.txt‑файл) с summary в начале\n"
        "  • html — html-отчёт (.html‑файл) с футером-резюме\n"
        "  • json — json-отчёт с расчётами: дельта, статус и флаги (.json‑файл)\n"
